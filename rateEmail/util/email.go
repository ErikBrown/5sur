...
<table width="100%" bgcolor="#E1E5E6">
	...
	<table cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; box-shadow: 0px 1px 2px #98A8AD;">
		...
		<tr height="1px">
			<td width="25px"></td>
			<td colspan="3" align="center" style="font-size: 12px; color: #989D9E;">Cancela tu suscripción a emails cambiando tus <a href="https://5sur.com/emailPreferences" style="text-decoration: none; color=#4DBBE6">preferencias de email</a>
			<td width="25px"></td>
		</tr>
		<tr height="35px"></tr>
	</table> 
